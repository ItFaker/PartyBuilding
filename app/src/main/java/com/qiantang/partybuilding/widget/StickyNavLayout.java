package com.qiantang.partybuilding.widget;
...
public class StickyNavLayout extends LinearLayout implements NestedScrollingParent {
    ...
    protected void onFinishInflate() {
        ...
        mViewPager = findViewById(R.id.bottom_view);
...
//        mViewPager = view;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(getMeasuredWidth(), mTop.getMeasuredHeight() + (mNav != null ? mNav.getMeasuredHeight() : 0) + mViewPager.getMeasuredHeight() - (bottomView != null ? bottomView.getMeasuredHeight() : 0));
    }

    @Override
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        super.onSizeChanged(w, h, oldw, oldh);
        mTopViewHeight = mTop.getMeasuredHeight() - (mNav != null ? mNav.getMeasuredHeight() : 0);
    }
