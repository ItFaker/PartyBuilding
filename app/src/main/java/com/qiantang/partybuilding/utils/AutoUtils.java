...
//        int height2 = dm.heightPixels - getStatusBarHeight(act);
//        Log.e("33333", "WindowManager: " + width2 + "==" + height2);
//        AutoUtils.displayWidth = MyApplication.widthPixels;
//        AutoUtils.displayHeight = 1920;
//        Log.e("33333", "setSize: " + displayWidth + "==" + displayHeight);
//        Log.e("111", "setSize: " + width + "---" + height);
    ...
    public static float getTextPixels(int designPx) {
        return (float)textPixelsRate * designPx;
    }
