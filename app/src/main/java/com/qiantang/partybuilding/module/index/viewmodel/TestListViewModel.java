 ...
 */
public class TestListViewModel implements ViewModel {
    private BaseBindActivity activity;
    private TestListAdapter listAdapter;
    private int pageNo = 1;

    public TestListViewModel(BaseBindActivity activity, TestListAdapter listAdapter) {
    ...
    public void getData() {
        ApiWrapper.getInstance().testList(pageNo)
