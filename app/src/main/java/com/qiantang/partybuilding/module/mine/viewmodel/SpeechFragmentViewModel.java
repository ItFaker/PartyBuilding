 ...
 */
public class SpeechFragmentViewModel implements ViewModel {
    private SpechAdapter adapter;
    private int pageNo = 1;
    private BaseBindFragment fragment;

    public SpeechFragmentViewModel(BaseBindFragment activity, SpechAdapter adapter) {
    ...
    public void testData() {
        ApiWrapper.getInstance().speechUserList(pageNo)
